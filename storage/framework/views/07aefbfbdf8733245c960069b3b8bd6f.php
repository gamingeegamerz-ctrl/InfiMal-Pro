...
<head>
    ...
    <title>InfiMal - Unlimited Email Sending | Professional Communication Platform</title>
...
<body class="bg-white" x-data="{ mobileMenuOpen: false }">
        ...
        <div class="max-w-7xl mx-auto">
            <div class="text-center fade-in">
                <h1 class="text-5xl lg:text-7xl font-bold text-gray-900 mb-6 leading-tight">
                    <span class="rainbow-text">Unlimited Email Sending</span>
                    <span class="block text-gray-900 mt-2">Made Professional & Scalable</span>
                </h1>
                <p class="text-xl lg:text-2xl text-gray-600 mb-8 max-w-3xl mx-auto leading-relaxed">
                    Send unlimited emails with enterprise-grade deliverability. Connect your SMTP, manage subscribers, and track campaigns in real-time — all in one platform.
                </p>
                ...
                <p class="text-gray-500 mt-6 text-sm">No limits on emails • One-time payment • Lifetime access</p>
            </div>
                    ...
                    <div class="bg-gradient-to-br from-gray-900 to-gray-800 rounded-2xl p-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <div class="bg-gray-800 rounded-xl p-4 text-center">
                                ...
                                <div class="text-gray-400 text-sm">Email Sending</div>
                            </div>
                            <div class="bg-gray-800 rounded-xl p-4 text-center">
                        ...
                        <div class="mt-6 text-center text-gray-500 text-sm">
                            Send unlimited campaigns with smart queue distribution
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="py-16 bg-gray-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-2 md:grid-cols-4 gap-8 text-center fade-in">
                <div>
                    <div class="text-4xl font-bold text-blue-600 mb-2">Unlimited</div>
                    <div class="text-gray-600">Email Credits</div>
                </div>
                <div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="glass-card rounded-2xl p-8 shadow-lg fade-in hover-glow transition-all duration-300">
                    ...
                    <h3 class="text-2xl font-bold text-gray-900 mb-4">Email Sending + SMTP</h3>
                    <p class="text-gray-600">Connect your own SMTP, add and verify domains with SPF, DKIM, and DMARC. Create campaigns and send bulk emails with full control over your sending infrastructure.</p>
                </div>
                ...
                <div class="glass-card rounded-2xl p-8 shadow-lg fade-in hover-glow transition-all duration-300">
                    ...
                    <p class="text-gray-600">Create and manage subscriber lists, import emails, track active and inactive status. Full control over your audience segmentation and list hygiene.</p>
                </div>
                ...
                <div class="glass-card rounded-2xl p-8 shadow-lg fade-in hover-glow transition-all duration-300">
                    ...
                    <h3 class="text-2xl font-bold text-gray-900 mb-4">Smart Queue System</h3>
                    <p class="text-gray-600">No instant blasts. Our system intelligently distributes emails with async processing and priority levels for transactional, fresh campaigns, and backlog messages.</p>
                </div>
                ...
                <div class="glass-card rounded-2xl p-8 shadow-lg fade-in hover-glow transition-all duration-300">
                    ...
                    <p class="text-gray-600">Create campaigns with status tracking for queued, sending, and sent states. Built-in drag-and-drop builder to design professional emails without coding.</p>
                </div>
                ...
                <div class="glass-card rounded-2xl p-8 shadow-lg fade-in hover-glow transition-all duration-300">
                    ...
                    <p class="text-gray-600">Track sent, delivered, bounce, complaint, open, click, and reply metrics. Hourly stats aggregation with cached dashboard for campaign and SMTP performance.</p>
                </div>
                ...
                <div class="glass-card rounded-2xl p-8 shadow-lg fade-in hover-glow transition-all duration-300">
                    ...
                    <h3 class="text-2xl font-bold text-gray-900 mb-4">SMTP Reputation Engine</h3>
                    <p class="text-gray-600">Track success rate, bounce rate, and complaint tracking per user SMTP. Intelligent reputation scoring for optimal delivery decisions.</p>
                </div>
                ...
                <div class="glass-card rounded-2xl p-8 shadow-lg fade-in hover-glow transition-all duration-300">
                    ...
                    <h3 class="text-2xl font-bold text-gray-900 mb-4">Safety and Throttling</h3>
                    <p class="text-gray-600">Production safety system with safe mode and global pause. Adaptive speed control with auto protection including bounce spike slowdown and complaint spike pause.</p>
                </div>
                ...
                <div class="glass-card rounded-2xl p-8 shadow-lg fade-in hover-glow transition-all duration-300">
                    ...
                    <h3 class="text-2xl font-bold text-gray-900 mb-4">Retry and Scheduler</h3>
                    <p class="text-gray-600">Exponential retry system with scheduled_at and retry_at logic. Fair scheduling distribution with backlog management and expiry controls.</p>
                </div>
                ...
                <div class="glass-card rounded-2xl p-8 shadow-lg fade-in hover-glow transition-all duration-300">
                    ...
                    <p class="text-gray-600">Work together with role-based permissions, shared templates, and collaborative campaign workflows. Perfect for agencies managing multiple client accounts.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section id="how-it-works" class="py-20 bg-gray-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16 fade-in">
                <h2 class="text-4xl font-bold text-gray-900 mb-4">Get Started in 5 Simple Steps</h2>
                <p class="text-xl text-gray-600">From setup to sending — start your unlimited email campaigns today</p>
            </div>

            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
                <!-- Step 1 -->
                <div class="text-center fade-in group">
                    <div class="step-number w-16 h-16 bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl flex items-center justify-center mx-auto mb-5 transform transition-all duration-300 group-hover:scale-110 shadow-lg">
                        <span class="text-2xl font-bold text-white">1</span>
                    </div>
                    <h3 class="text-xl font-bold text-gray-900 mb-2">Create Account</h3>
                    <p class="text-gray-500 text-sm">Sign up in seconds. Get instant lifetime access with unlimited email credits.</p>
                </div>
                ...
                <div class="text-center fade-in group">
                    ...
                    <h3 class="text-xl font-bold text-gray-900 mb-2">Connect SMTP</h3>
                    <p class="text-gray-500 text-sm">Add your SMTP provider, verify domain with SPF, DKIM, and DMARC, then start sending.</p>
                </div>
                ...
                <div class="text-center fade-in group">
                    ...
                    <h3 class="text-xl font-bold text-gray-900 mb-2">Import Contacts</h3>
                    <p class="text-gray-500 text-sm">Upload CSV or connect via API. Manage lists, segments, and subscriber status.</p>
                </div>
                ...
                <div class="text-center fade-in group">
                    ...
                    <h3 class="text-xl font-bold text-gray-900 mb-2">Design Campaign</h3>
                    <p class="text-gray-500 text-sm">Drag-and-drop builder. Create responsive emails that match your brand perfectly.</p>
                </div>
                ...
                <div class="text-center fade-in group">
                    ...
                    <h3 class="text-xl font-bold text-gray-900 mb-2">Send and Track</h3>
                    <p class="text-gray-500 text-sm">Launch campaigns. Monitor opens, clicks, bounces in real-time analytics.</p>
                </div>
            </div>

            <div class="mt-12 text-center fade-in">
                <div class="inline-block bg-blue-50 border border-blue-200 rounded-full px-6 py-2">
                    <p class="text-blue-700 text-sm font-medium">Smart queue system distributes your emails automatically — no instant blasts, better deliverability</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-20 bg-gray-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-12">
                <div class="fade-in">
                    <h3 class="text-2xl font-bold text-gray-900 mb-4">Unlimited Email Sending</h3>
                    <p class="text-gray-600 mb-4">No monthly limits, no hidden fees. Pay once and send unlimited emails forever. Whether you send 1,000 or 1 million emails monthly, the price stays the same.</p>
                    <p class="text-gray-600">Perfect for growing businesses that don't want to worry about usage caps or surprise overage charges.</p>
                </div>
                <div class="fade-in">
                ...
                <div class="fade-in">
                    <h3 class="text-2xl font-bold text-gray-900 mb-4">Compliance and Security First</h3>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div class="glass-card rounded-2xl p-8 shadow-lg fade-in">
                    ...
                    <p class="text-gray-600 mb-4">"Unlimited email sending changed everything for us. No more worrying about monthly limits. InfiMal just works."</p>
                ...
                <div class="glass-card rounded-2xl p-8 shadow-lg fade-in">
                    ...
                    <p class="text-gray-600 mb-4">"The SMTP connection was super easy. Connected in 2 minutes and started sending campaigns right away. Best investment."</p>
                ...
                <div class="glass-card rounded-2xl p-8 shadow-lg fade-in">
                    ...
                    <p class="text-gray-600 mb-4">"Reliable, powerful, and truly unlimited. InfiMal handles our high-volume campaigns without breaking a sweat."</p>
            ...
            <div class="space-y-6" x-data="{ openFaq: null }">
                <div class="glass-card rounded-2xl shadow-lg fade-in">
                    <button @click="openFaq = openFaq === 1 ? null : 1" class="w-full p-6 text-left flex justify-between items-center">
                        <span class="text-lg font-semibold text-gray-900">Is it really unlimited email sending?</span>
                    ...
                    <div x-show="openFaq === 1" x-transition class="px-6 pb-6">
                        <p class="text-gray-600">Yes. One-time payment gives you lifetime access with unlimited email sending. No monthly caps, no hidden fees. Send as many campaigns as you want, whenever you want.</p>
                    </div>
                </div>
                <div class="glass-card rounded-2xl shadow-lg fade-in">
                    <button @click="openFaq = openFaq === 2 ? null : 2" class="w-full p-6 text-left flex justify-between items-center">
                        <span class="text-lg font-semibold text-gray-900">Can I use my own SMTP provider?</span>
                    ...
                    <div x-show="openFaq === 2" x-transition class="px-6 pb-6">
                        <p class="text-gray-600">Absolutely. You can connect any SMTP provider. We support all major providers and help you verify your domain with SPF, DKIM, and DMARC for maximum deliverability.</p>
                    </div>
                </div>
                <div class="glass-card rounded-2xl shadow-lg fade-in">
                    <button @click="openFaq = openFaq === 3 ? null : 3" class="w-full p-6 text-left flex justify-between items-center">
                        <span class="text-lg font-semibold text-gray-900">Can I integrate with my existing tools?</span>
                    ...
                    <div x-show="openFaq === 3" x-transition class="px-6 pb-6">
                        <p class="text-gray-600">Yes. InfiMal offers a comprehensive RESTful API that allows you to integrate with CRMs, e-commerce platforms, analytics tools, and custom applications.</p>
                    </div>
                </div>
                <div class="glass-card rounded-2xl shadow-lg fade-in">
                    <button @click="openFaq = openFaq === 4 ? null : 4" class="w-full p-6 text-left flex justify-between items-center">
                        <span class="text-lg font-semibold text-gray-900">What analytics can I track?</span>
                    ...
                    <div x-show="openFaq === 4" x-transition class="px-6 pb-6">
                        <p class="text-gray-600">Track sent, delivered, bounce, complaint, open, click, and reply metrics in real-time. Hourly stats with campaign and SMTP performance dashboards.</p>
                    </div>
                </div>
                <div class="glass-card rounded-2xl shadow-lg fade-in">
                    ...
                    <div x-show="openFaq === 5" x-transition class="px-6 pb-6">
                        <p class="text-gray-600">Absolutely. Bank-level encryption for all data. Fully compliant with GDPR, CAN-SPAM, and international regulations. 24/7 security monitoring.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section id="pricing" class="py-20 bg-white">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16 fade-in">
                ...
                <p class="text-xl text-gray-600">One payment, unlimited emails — lifetime access</p>
            </div>
            ...
            <div class="glass-card rounded-3xl shadow-2xl border-2 border-blue-500 relative overflow-hidden fade-in hover-glow">
                ...
                <div class="p-12 text-center">
                    <h3 class="text-3xl font-bold text-gray-900 mb-2">Unlimited Lifetime</h3>
                    ...
                    <div class="text-green-600 font-semibold mb-6">Unlimited Emails · No Monthly Fees</div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 text-left mb-12">
                        <div class="flex items-center">
                            ...
                            <span class="text-gray-700">Unlimited Email Sending</span>
                        </div>
                        <div class="flex items-center">
                            <svg class="w-6 h-6 text-green-500 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                            </svg>
                            <span class="text-gray-700">SMTP Provider Support</span>
                        </div>
                        <div class="flex items-center">
                            <svg class="w-6 h-6 text-green-500 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                        ...
                        <div class="flex items-center">
                            ...
                            <span class="text-gray-700">Smart Queue System</span>
                        </div>
                        <div class="flex items-center">
                            <svg class="w-6 h-6 text-green-500 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                        ...
                        <div class="flex items-center">
                            ...
                            <span class="text-gray-700">Lifetime Updates and Support</span>
                        </div>
                    </div>
    ...
    <section class="py-20 bg-gradient-to-br from-blue-600 to-purple-600">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center fade-in">
            <h2 class="text-4xl lg:text-5xl font-bold text-white mb-6">Ready to Send Unlimited Emails?</h2>
            <p class="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">Join thousands of businesses using InfiMal to send unlimited campaigns with professional deliverability and real-time analytics.</p>
            ...
            <p class="text-blue-100 mt-6 text-sm">One-time payment · Unlimited emails · Lifetime access</p>
        </div>
    </section>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                <div>
                    ...
                    <p class="text-gray-400">Unlimited email sending platform for agencies and businesses. One payment, lifetime access.</p>
                </div>
                <div>
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-gray-400">
                        ...
                        <li><a href="https://infimal.site/terms" class="hover:text-white transition">Terms and Conditions</a></li>
                        <li><a href="https://infimal.site/refund" class="hover:text-white transition">Refund Policy</a></li>
                    </ul>
                </div>
            </div>
            <div class="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
                <p>&copy; 2026 InfiMal. All rights reserved. | Unlimited Email Sending Platform</p>
            </div>
        </div>
    </footer>
...
<?php /**PATH /var/www/InfiMal-Pro/resources/views/public/index.blade.php ENDPATH**/ ?>