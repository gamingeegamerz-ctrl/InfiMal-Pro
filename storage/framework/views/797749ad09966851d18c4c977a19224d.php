...
<body class="bg-white dark:bg-slate-900 text-gray-900 dark:text-slate-100 transition-colors duration-300">
        ...
        <aside class="w-64 bg-white dark:bg-slate-800 border-r border-gray-200 dark:border-slate-700 flex-shrink-0">
            <div class="flex flex-col h-full p-4">
                ...
                <nav class="flex flex-col gap-1 flex-1">
                    <a class="nav-link flex items-center gap-3 px-3 py-2.5 rounded-lg text-gray-700 dark:text-slate-300 hover:text-gray-900 dark:hover:text-white font-medium text-sm" href="<?php echo e(url('/dashboard')); ?>">
                    ...
                    <a class="nav-link active flex items-center gap-3 px-3 py-2.5 rounded-lg text-gray-700 dark:text-slate-300 hover:text-gray-900 dark:hover:text-white font-medium text-sm" href="<?php echo e(url('/smtp')); ?>">
            ...
            <div class="p-6 space-y-6">
                        ...
                        <div>
                            ...
                            <div class="flex items-center gap-6">
                                <div class="flex items-center gap-2">
                                    ...
                                    <span class="text-gray-600 dark:text-slate-300 text-sm font-medium" id="totalConfigs"><?php echo e($totalSmtp); ?> Configurations</span>
                                </div>
                                <div class="flex items-center gap-2">
                                    <span class="material-symbols-outlined text-blue-500 text-xl">check_circle</span>
                                    <span class="text-gray-600 dark:text-slate-300 text-sm font-medium" id="activeConfigs"><?php echo e($activeSmtp); ?> Active</span>
                                </div>
                                <div id="smtp-status" class="flex items-center gap-2">
                                    <span class="w-2 h-2 <?php echo e($smtpStatus == 'Active' ? 'bg-green-500' : ($smtpStatus == 'Failed' ? 'bg-red-500' : 'bg-gray-400')); ?> rounded-full"></span>
                                    <span class="text-gray-600 dark:text-slate-300 text-xs font-medium">System Status: <?php echo e($smtpStatus); ?></span>
                                </div>
                            </div>
                        </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    <div class="glass-card rounded-2xl p-6 shadow-lg hover-glow transition-all duration-300">
                        ...
                        <p class="text-4xl font-bold text-gray-900 dark:text-white mb-2" id="statTotal"><?php echo e($totalSmtp); ?></p>
                        <p class="text-green-600 dark:text-green-400 text-sm font-medium" id="statActive"><?php echo e($activeSmtp); ?> active</p>
                    </div>
                    ...
                    <div class="glass-card rounded-2xl p-6 shadow-lg hover-glow transition-all duration-300">
                        ...
                        <p class="text-4xl font-bold text-gray-900 dark:text-white mb-2"><?php echo e(number_format($usageStats['sent_today'])); ?></p>
                    ...
                    <div class="glass-card rounded-2xl p-6 shadow-lg hover-glow transition-all duration-300">
                        ...
                        <p class="text-4xl font-bold text-gray-900 dark:text-white mb-2"><?php echo e(number_format($usageStats['sent_this_month'])); ?></p>
                    ...
                    <div class="glass-card rounded-2xl p-6 shadow-lg hover-glow transition-all duration-300">
                        ...
                        <p class="text-4xl font-bold text-gray-900 dark:text-white mb-2"><?php echo e($usageStats['success_rate']); ?>%</p>
                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full">
                            ...
                            <tbody id="smtpTableBody">
                                ...
                                <tr class="border-b border-gray-100 dark:border-slate-800 hover:bg-gray-50 dark:hover:bg-slate-800/50 transition-colors" data-id="<?php echo e($smtp->id); ?>">
                                    <td class="p-3">
                                        <span class="status-badge inline-flex items-center gap-1 px-2 py-1 rounded-full text-xs font-medium <?php echo e($smtp->is_active ? 'bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-400' : 'bg-red-100 text-red-700 dark:bg-red-900/30 dark:text-red-400'); ?>">
                                            <span class="w-1.5 h-1.5 rounded-full <?php echo e($smtp->is_active ? 'bg-green-500' : 'bg-red-500'); ?>"></span>
                                            <?php echo e($smtp->is_active ? 'Active' : 'Inactive'); ?>

                                        </span>
                                    </td>
                                    <td class="p-3">
                                        <div class="flex flex-col">
                                            <p class="text-gray-900 dark:text-white font-medium"><?php echo e($smtp->name ?? $smtp->host); ?></p>
                                            <p class="text-gray-500 dark:text-slate-400 text-xs"><?php echo e($smtp->host); ?>:<?php echo e($smtp->port); ?> (<?php echo e(strtoupper($smtp->encryption)); ?>)</p>
                                        </div>
                                    </td>
                                    <td class="p-3">
                                        <div class="flex flex-col">
                                            <p class="text-gray-900 dark:text-white text-sm"><?php echo e($smtp->from_address); ?></p>
                                            <p class="text-gray-500 dark:text-slate-400 text-xs"><?php echo e($smtp->from_name); ?></p>
                                        </div>
                                    </td>
                                    <td class="p-3">
                                        <div class="flex flex-col">
                                            <p class="text-gray-900 dark:text-white text-sm font-medium"><?php echo e($smtp->sent_today ?? 0); ?>/<?php echo e($smtp->daily_limit ?? 500); ?></p>
                                    ...
                                    <td class="p-3">
                                        <p class="text-gray-900 dark:text-white text-sm font-medium"><?php echo e(number_format($smtp->total_sent ?? 0)); ?></p>
                                    ...
                                    <td class="p-3">
                                        ...
                                        <p class="text-gray-900 dark:text-white text-sm"><?php echo e(\Carbon\Carbon::parse($smtp->last_used_at)->format('M d, Y')); ?></p>
                                        <p class="text-gray-500 dark:text-slate-400 text-xs"><?php echo e(\Carbon\Carbon::parse($smtp->last_used_at)->format('h:i A')); ?></p>
                                        <?php else: ?>
                                    ...
                                    <td class="p-3">
                                        <div class="flex items-center gap-1">
                                            <button onclick="testSmtp(<?php echo e($smtp->id); ?>)" class="test-btn p-1.5 rounded-lg hover:bg-gray-100 dark:hover:bg-slate-700 transition-colors" data-id="<?php echo e($smtp->id); ?>" title="Test Connection">
                                                <span class="material-symbols-outlined text-blue-500 text-sm">play_arrow</span>
                                            </button>
                                            <button onclick="toggleSmtp(<?php echo e($smtp->id); ?>)" class="toggle-btn p-1.5 rounded-lg hover:bg-gray-100 dark:hover:bg-slate-700 transition-colors" data-id="<?php echo e($smtp->id); ?>" title="<?php echo e($smtp->is_active ? 'Deactivate' : 'Activate'); ?>">
                                                <span class="material-symbols-outlined text-yellow-500 text-sm"><?php echo e($smtp->is_active ? 'toggle_off' : 'toggle_on'); ?></span>
                                            </button>
                                            <button onclick="editSmtp(<?php echo e($smtp->id); ?>)" class="p-1.5 rounded-lg hover:bg-gray-100 dark:hover:bg-slate-700 transition-colors" title="Edit">
                                                <span class="material-symbols-outlined text-emerald-500 text-sm">edit</span>
                                            </button>
                                            <button onclick="deleteSmtp(<?php echo e($smtp->id); ?>)" class="p-1.5 rounded-lg hover:bg-gray-100 dark:hover:bg-slate-700 transition-colors" title="Delete">
    ...
    <script>
        ...
        function initCharts() {
            ...
            const dailyLabels = <?php echo json_encode($dailyLabels ?? ['Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat', 'Sun']); ?>;
            const dailyData = <?php echo json_encode($dailyUsageData ?? [0, 0, 0, 0, 0, 0, 0]); ?>;
            ...
            if (distCtx) {
                const smtpNames = <?php echo json_encode($smtpSettings->pluck('name')->map(fn($n, $i) => $n ?: 'SMTP ' . ($i + 1))); ?>;
                const smtpData = <?php echo json_encode($smtpSettings->pluck('total_sent')); ?>;
...
<?php /**PATH /var/www/infimal--Local/resources/views/smtp/index.blade.php ENDPATH**/ ?>