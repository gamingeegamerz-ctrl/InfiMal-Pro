...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div class="text-right">
                        <a href="<?php echo e(route('password.request')); ?>" class="text-sm text-blue-600 font-medium hover:text-blue-700">Forgot password?</a>
                    </div>
                </div>
            </form>
...
<?php /**PATH /var/www/InfiMal-Pro/resources/views/auth/login.blade.php ENDPATH**/ ?>