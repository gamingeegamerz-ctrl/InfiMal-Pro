...
</div><h1 class="text-4xl font-bold mb-4">Help Center</h1><p>Get help and support</p><a href="/" class="mt-4 bg-blue-600 text-white px-4 py-2 rounded">Go Home</a></div></body></html>
